...
Use /legacy-study-inbox para estudar legado.
...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `Import Legacy` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
