...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `02 Event Bus` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
