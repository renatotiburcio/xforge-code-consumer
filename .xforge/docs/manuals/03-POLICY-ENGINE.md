...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `03 Policy Engine` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
