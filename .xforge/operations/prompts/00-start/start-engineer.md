...
Execute /development-recognize-project e estude tudo.
...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `Start Engineer` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
