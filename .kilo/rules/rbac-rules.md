...
- promover conhecimento para enterprise-standard;
- alterar policy engine;
- publicar skill;
- alterar workflow;
...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `Rbac Rules` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
