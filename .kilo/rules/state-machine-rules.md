...
1. Todo workflow deve iniciar em estado conhecido.
2. Transições inválidas são proibidas.
3. Falha deve ir para FAILED com motivo.
4. Operação concluída deve passar por MEMORIZING e INDEXING.
5. Ações críticas devem permitir rollback/snapshot.
...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `State Machine Rules` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
