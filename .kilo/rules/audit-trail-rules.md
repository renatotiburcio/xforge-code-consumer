...
Use este artefato quando a solicitação, workflow, agente ou rotina envolver `Audit Trail Rules` ou depender desta capacidade para tomar uma decisão técnica, operacional, arquitetural, de memória, governança ou qualidade.
